...
public class ArmstrongNumberController {
     ...
     */
    @ApiOperation(value = "Find amstrong numbers in the given range. An Armstrong number of 3 digit is a number for which sum of cube of its digits are equal to number")
