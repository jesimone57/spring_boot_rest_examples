...
public class PalindromicNumberControllerExceptionTest extends ControllerTestBase {
    ...
    @Test
    public void test1() {
        String url = "http://localhost:" + port + URL_PALINDROMES;
    ...
    @Test
    public void test2() {
        String url = "http://localhost:" + port + URL_PALINDROMES + "?start=1";
        ResponseEntity<String> response = restTemplate.getForEntity(url, String.class);
    ...
    @Test
    public void test3() {
        String url = "http://localhost:" + port + URL_PALINDROMES + "?start=a&end=5";
        ResponseEntity<String> response = restTemplate.getForEntity(url, String.class);
    ...
    @Test
    public void test4() {
        String url = "http://localhost:" + port + URL_PALINDROMES + "?start=6&end=5";
        ResponseEntity<String> response = restTemplate.getForEntity(url, String.class);
